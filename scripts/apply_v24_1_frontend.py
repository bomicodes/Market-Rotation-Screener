...
sub(r'const gx=gexImplicationFor\(x\.ticker,c\);if\(gx\.detail\.includes\("headwind"\)\)score-=4;else if\(gx\.detail\.includes\("accelerate"\)\)score\+=3;', '', 'GEX double count')
