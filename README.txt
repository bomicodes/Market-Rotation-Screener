...
- Login password comparison now uses a constant-time check (hmac.compare_digest) instead of a direct string comparison, removing a timing side-channel.
